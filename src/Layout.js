        ...
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex justify-between items-center">
            <Link to={createPageUrl("Home")} className="flex items-center gap-3 text-xl md:text-2xl font-bold text-amber-800">
              <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/99ff5df70_.png" alt="לוגו - גיל ברדוגו נסים" className="w-10 h-10 md:w-14 md:h-14 rounded-full object-cover border-2 border-amber-100" />
