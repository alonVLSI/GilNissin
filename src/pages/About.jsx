      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-sky-50 py-8 px-8 mb-12">
          <div className="space-y-8 text-lg text-gray-700 leading-relaxed text-justify">
            <p>
נעים להכיר, שמי גיל. אני פסיכותרפיסטית מוסמכת המטפלת במבוגרים ובנוער, וכן מציעה טיפול מונחה הורים וטיפול משפחתי.
בבסיס עבודתי הטיפולית עומדת הגישה הדינמית, המעניקה קשב מעמיק לשיח הפנימי המעצב את תפיסת העצמי ומשפיע על חוויית החיים. 
אני מאמינה בקשר ההדוק שבין גוף לנפש, ונותנת לו מקום מרכזי בתהליך הטיפולי. תחומי הטיפול העיקריים בהם אני מתמחה כוללים: התמודדות עם לחץ, חרדה ומתח נפשי, קשיים בתקשורת בינאישית ובמערכות יחסים, ליווי בתקופות של שינוי, משבר והסתגלות, דימוי עצמי ודימוי גוף, וכן טיפול בהתנהגויות אכילה.
לצד עבודתי בקליניקה הפרטית, אני מטפלת במרכז להורות ומשפחה, מנחה קבוצות ומרצה בתחום.
            </p>
