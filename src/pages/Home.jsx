          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
				...
				דרכי המקצועית והאישית התעצבה מתוך הדיאלוג המתמיד והמפגש העמוק בין הנפש והגוף. למדתי להכיר 
				בכך שהגוף מבטא את הנפש בשפתו הייחודית, וכי הנפש, בתורה, פוגשת את הגוף, נוגעת בו ומדברת דרכו.
				</p>
				
				<p className="text-lg text-gray-600 leading-relaxed">
				כפסיכותרפיסטית בגישה פסיכודינמית, אני מקדישה קשב רב לשיח הפנימי הזה, ופועלת מתוך הבנה 
				שהגוף אינו כלי קיבול פסיבי, אלא שותף פעיל הנושא בתוכו זיכרונות, חוויות ותחושות. כל אלו נרשמים בו, 
				ודרכו הם מוצאים את ביטויים. הקשבה מעמיקה לדיאלוג הפנימי מאפשרת לחלקים השונים בתוכנו לקבל 
				מקום והכרה.
				</p>
				
				<p className="text-lg text-gray-600 leading-relaxed">
				בכך, נפתח פתח לחוויית חיים מלאה יותר, לתחושת שלמות וליצירת חיבור אותנטי וחומל בין 
				כל חלקי העצמי. תפיסתי הטיפולית נשענת על ידע וניסיון מקצועי רב-תחומי, הכולל הכשרה אקדמית בחינוך 
				מיוחד ובגיל הרך (A.M), התמחות בטיפול בהתנהגויות אכילה, והסמכה בפסיכותרפיה פסיכודינמית.
				</p>
              </div>
