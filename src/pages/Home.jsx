    ...
    <>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-justify space-y-6 text-lg text-gray-700 leading-relaxed">
				...
				הלא-מילולית, הוא מבטא את מה שלפעמים קשה להגיד במילים.<br />
				מתח נפשי מתמשך יכול להתבטא בכיווץ שרירים, חוויות עבר עלולות להדהד בכאבים פיזיים,
